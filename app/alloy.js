...
Alloy.menuListArray = function(userType){
	...
	var menuArray =  [ {title: 'Active Needs', key:'activeneeds' }, {title: 'Completed Needs', key:'completed'},
                    {title: 'My Stats', key:'stats'}, {title: 'My Profile', key:'profile'},{title: 'Settings', key:'settings'},
                    {title: '', key:''},{title: 'Help', key:'help'} ];
